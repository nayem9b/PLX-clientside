  ...
  return (
    <div>
      <footer aria-label='Site Footer' class='bg-gray-100'>
        <div class='mx-auto max-w-screen-xl px-4 py-1 sm:px-6 lg:px-8'>
          <div class='mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5'>
            <div class='text-center sm:text-left'>
              <p class='text-lg font-medium text-gray-900'>Popular Locations</p>
            ...
            <div class='text-center sm:text-left'>
              <p class='text-lg font-medium text-gray-900'>PLX</p>
        ...
        <div class='mt-16 bg-teal-900 px-16'>
          <div class='mt-16 sm:flex sm:items-center sm:justify-between'>
            <div class='flex justify-center  sm:justify-start'>
              <img src={logo} alt='' className='w-24 ' />
            </div>

            <p class='mt-4 text-center text-sm text-white sm:mt-0 sm:text-right'>
